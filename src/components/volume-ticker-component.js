...
export default function TransactionTicker(props) {
    ...
    const [backDate, setBackDate] = useState(90);
  ...
  useEffect(() => {
    ...
    return (
      ...
      {isLoading ? ( <div>Loading ...</div>) : (
          ...
          <button className="chart-button" onClick={()=>{setBackDate(3 * 30)}}>3M</button>
          ...
          <RouterLink className="link-button" to={`/transactions/${props.ticker}`}>Price</RouterLink>
