...
import { INDEX_UPLOAD_URL, MAX_INDEX_TRANS_URL, safeHeaders, safeHeadersMultiPart } from './api-config';
...
export default function IndexUploadComponent() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setIsLoading(true);
        ...
        try {
        const result = await axios.get(MAX_INDEX_TRANS_URL, safeHeaders);
        setData(result.data);
